  ...
  const features = [
    {
      ...
      description: "Create secure savings vaults with customized goals, timelines, and automatic deposits that adapt to your financial rhythm.",
    ...
    },
    {
      ...
      description: "Send money to friends and family instantly with zero fees, using our advanced payment network that bridges traditional and digital finance.",
    ...
    },
    {
      ...
      description: "Save together with trusted circles in a modern take on traditional group savings, building community while achieving collective financial goals.",
    ...
    },
    {
      ...
      description: "Track every transaction with detailed analytics and personalized insights that reveal spending patterns and suggest optimizations unique to you.",
              ...
              {features.map((feature, index) => (
                ...
                >
                  <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                    ...
                    <div className="p-8">
                      <div className="mb-6">
                        <span className={`inline-flex items-center justify-center p-3 rounded-md bg-opacity-10 ${feature.textColor} bg-${feature.textColor.split('-')[1]}-100`}>
                          <svg 
                            xmlns="http://www.w3.org/2000/svg" 
                            fill="none" 
                            viewBox="0 0 24 24" 
                      ...
                      <h3 className="text-2xl font-bold text-gray-900 mb-4">{feature.title}</h3>                      <p className="text-gray-600 text-lg mb-8">{feature.description}</p>
                      
                      <div className="relative h-36 md:h-44 bg-gray-100 rounded-lg overflow-hidden">
